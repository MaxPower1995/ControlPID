...
#define CAL_SUP 0.0625 //mide con - 0.0625 de error, se ajusto 31/1/24
...
/* const char* SSID = "Edificio INNOVA";
const char* PASS = "Mexico932"; */
...
average_inf = sum_inf / 50;
  ...
  // Si han pasado 4 horas desde la última vez que se reinició el dispositivo
  if (millis() - lastRestartTime >= 14400000) {
